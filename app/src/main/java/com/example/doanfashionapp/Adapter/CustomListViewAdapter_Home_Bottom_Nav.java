...
public class CustomListViewAdapter_Home_Bottom_Nav extends ArrayAdapter {
    ...
    public CustomListViewAdapter_Home_Bottom_Nav(@NonNull Context context, int resource, ArrayList<HangSanPham> arrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        CustomRecyclerViewAdapter_Home_Bottom_Nav adapter = new CustomRecyclerViewAdapter_Home_Bottom_Nav(sp.getListSP(),context);
